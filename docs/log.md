...
* **Architecture Expansion**: `docs/architecture/gemma_and_quantization.md` - Gemma 2 / Gemma 4 の 262K 巨大語彙に対する Sliced LM-Head のスケーリング優位性および 4-bit/8-bit 量子化仕様を文書化。
* **Deep Evaluation Suite**: `docs/references/deep_benchmarks_specification.md` - 10大ドメイン計100問の網羅的データセット仕様（`deep_eval_cases.json`）を策定。
