...
**[Japanese]**
1. **Gemma 4 4-bit (bitsandbytes NF4)**:
   - **高い精度保持**: 4-bit 化しても 91.0%（10ドメイン中6ドメインで100%）という高い推論精度を維持。語彙サイズ 26.2万語による日本語複合語の解釈力は量子化後も強固に保たれます。
...
2. **Qwen 2.5 1.5B AWQ (Marlin カーネル)**:
   - **低遅延化**: Marlin 最適化カーネルの恩恵により、p50 遅延は **31.41 ms** と、量子化前（BF16: 34.84 ms）よりも高速化を達成しました。
